...
const Sales: React.FC = () => {
  ...
  const sales = [
    { id: '#SALE-001', customer: 'John Smith', product: 'iPhone 15 Pro', amount: 82917, date: '2024-01-15', status: 'Completed' },
    { id: '#SALE-002', customer: 'Sarah Johnson', product: 'MacBook Air M2', amount: 99517, date: '2024-01-14', status: 'Completed' },
    { id: '#SALE-003', customer: 'Mike Brown', product: 'AirPods Pro', amount: 20667, date: '2024-01-13', status: 'Completed' },
    { id: '#SALE-004', customer: 'Emma Wilson', product: 'iPad Air', amount: 599, date: '2024-01-14', status: 'Completed' },
    { id: '#SALE-005', customer: 'David Lee', product: 'Apple Watch', amount: 399, date: '2024-01-13', status: 'Completed' },
  ];
    ...
    <div className="p-4 sm:p-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 sm:mb-6 space-y-3 sm:space-y-0">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">Manage and track your sales</p>
        </div>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {sales.map((sale) => (
                <tr key={sale.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">₹{sale.amount.toLocaleString('en-IN')}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
